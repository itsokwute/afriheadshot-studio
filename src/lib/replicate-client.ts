...
export async function runHeadshotGeneration(config: GenerationConfig): Promise<GeneratedResult> {
  ...
  if (token) {
    try {
      ...
      console.warn('Replicate API execution failed, utilizing studio vector renderer:', err);
    }
  }
...
function createDynamicPortraitSvg(config: GenerationConfig, seed: number): string {
  ...
  <g filter="url(#shadow)">
    ...
    <path d="M ${width * 0.15} ${height} Q ${width * 0.3} ${height * 0.65} ${width * 0.4} ${height * 0.68} L ${width * 0.5} ${height * 0.73} L ${width * 0.6} ${height * 0.68} Q ${width * 0.7} ${height * 0.65} ${width * 0.85} ${height} Z" fill="url(#suitGrad)" />
    ...
    <path d="M ${width * 0.29} ${height * 0.38} C ${width * 0.28} ${height * 0.2} ${width * 0.4} ${height * 0.17} ${width * 0.5} ${height * 0.17} C ${width * 0.6} ${height * 0.17} ${width * 0.72} ${height * 0.2} ${width * 0.71} ${height * 0.38} C ${width * 0.68} ${height * 0.30} ${width * 0.58} ${height * 0.23} ${width * 0.5} ${height * 0.23} C ${width * 0.42} ${height * 0.23} ${width * 0.32} ${height * 0.30} ${width * 0.29} ${height * 0.38} Z" fill="#0d0907" stroke="#1c130d" stroke-width="3" />
  </g>

  <!-- Executive Overlay Badge -->
  <text x="${width * 0.05}" y="${height * 0.94}" font-family="sans-serif" font-weight="700" font-size="22" fill="#ffffff" opacity="0.9">
    AFRIHEADSHOT STUDIO
  </text>
  <text x="${width * 0.05}" y="${height * 0.97}" font-family="sans-serif" font-weight="400" font-size="14" fill="#94a3b8" opacity="0.8">
